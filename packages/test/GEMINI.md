...
| ------ | -------------------------- | ------------------------------------ | ------------------ |
| Web    | `web/{entity}.test.tsx`    | bun:test + HappyDOM                  | `web/GEMINI.md`    |
| Mobile | `mobile/{entity}.test.tsx` | Jest + @testing-library/react-native | `mobile/GEMINI.md` |
...
**Read the platform-specific guide (`web/GEMINI.md` or `mobile/GEMINI.md`) before writing any test code.**
