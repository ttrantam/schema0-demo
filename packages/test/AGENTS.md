...
| ------ | -------------------------- | ------------------------------------ | ------------------ |
| Web    | `web/{entity}.test.tsx`    | bun:test + HappyDOM                  | `web/AGENTS.md`    |
| Mobile | `mobile/{entity}.test.tsx` | Jest + @testing-library/react-native | `mobile/AGENTS.md` |
...
**Read the platform-specific guide (`web/AGENTS.md` or `mobile/AGENTS.md`) before writing any test code.**
